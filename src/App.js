...
class App extends React.Component {
  ...
  calculateFaceLocation = (data) => {
    ...
    return {
      ...
      // it is substracted from the top so total height minus bottom percentage * height
  ...
  displayCelebrity = (celebrityData) => {
    this.setState({ celebrity: celebrityData });
  }
  ...
  onButtonSubmit = () => {
    ...
    fetch('https://gentle-lake-86764.herokuapp.com/imageurl', {
      ...
      .catch(err => {
        ...
        this.setState({
          celebrity: {
            celebrityName: 'Could not load your picture. Please try another link.',
            probability: '0'
          }
        });
      });
